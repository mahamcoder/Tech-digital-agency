      ...
      <div className="mx-auto grid max-w-7xl gap-12 px-5 md:px-10 lg:grid-cols-[0.85fr_1.15fr]">
        <Reveal>
          ...
          <h2 className="mt-6 font-display text-3xl font-medium leading-[1.1] tracking-[-0.03em] text-foreground sm:text-5xl">
            Questions,
            <span className="block font-serif italic">answered clearly</span>
          </h2>
          ...
          {faqs.map((f, i) => {
            ...
            return (
              <Reveal key={f.q} delay={i * 0.06}>
                <div
                  className={`glass overflow-hidden rounded-3xl transition-colors duration-500 ${
                    isOpen ? "border-primary/40" : "hover:border-primary/25"
                  }`}
                >
                  <button
                    type="button"
